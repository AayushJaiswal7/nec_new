...
const AddLabourMaster = () => {
  ...
  const breadcrumbItems = [
    ...
    { label: "Add", href: "/master/add-labour-master" },
  ];
    ...
    <Breadcrumb items={breadcrumbItems} onBackRoute={handleBackRoute} />
      <div className="p-5 space-y-10">
        ...
        <div className="flex flex-wrap gap-5 md:gap-20">
          <InputField
            label="Labour Master Code"
            placeholder="Labour Master Code"
            width="w-60"
          />

          <InputField
            label="Labour Master Name"
            placeholder="Labour Master Name"
            width="w-60"
          />
        </div>
        {/* ---------- Row 2: Description ---------- */}
...
export default AddLabourMaster;
